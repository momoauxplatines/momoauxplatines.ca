...
[x] 879:4256 — Header admin unifié : flex justify-between tous breakpoints, logo gauche, tabs droite (gap 16px), Sign out et header-left retirés du HTML, padding-top content 96px
